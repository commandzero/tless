...
Cover conversions, framing, typed YAML values, malformed input, minimal builds, input limits, broken pipes, and unchanged interactive commands. Use explicit YAML key syntax for long or escape-heavy string keys, with round-trip boundary tests. Update help and migration documentation for the incompatible default.
