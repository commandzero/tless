...
Select absolute subtrees consistently across CLI pipelines and interactive viewing, while retaining original value identity and atomic multi-document behavior.
